...
const InsertBlog = () => {
  ...
  const [schemaName, setSchemaName] = useState('technology');
  ...
  const handleSubmit = async (event) => {
    ...
    fetch('https://gmblogserver.onrender.com/insertblogs', {
      method: 'POST',
      headers: {
...
return (
    <div className="container" style={{ backgroundImage: 'url("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS0zUhvJROxV6FnpsaCSC9p7jZ_2U4Nz8ei9w&usqp=CAU")', backgroundSize: 'cover', height: '100%' }}>
      <h1 style={{ textAlign: 'center', marginBottom: '20px', color: '#333' }}>Create a Technology Blog</h1>
